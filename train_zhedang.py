...
def func_path(x):
    x = x.replace('img/','/mnt/workdir/fengwei/xiapeng/cognitive_guanxin/show/').replace('ikang/','/mnt/workdir/fengwei/xiapeng/cognitive_guanxin/show/')
...
qc_df["path"] = qc_df["path"].apply(lambda x: x.replace('img/','/mnt/workdir/fengwei/xiapeng/cognitive_guanxin/show/'))
