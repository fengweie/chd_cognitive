...
df_train = df_all[df_all['测评日期']<=pd.datetime(2022,12,31)]
df_train = df_train.reset_index(drop=True) 
df_test = df_all[df_all['测评日期']>pd.datetime(2022,12,31)]
...
save_path = './model/'+label+'/'+"resnet101"+'_chd_2409.pth'
...
save_path = './model/'+label+'/'+"resnet50"+'_chd_2409.pth'
...
save_path = './model/'+label+'/'+"inceptionv3"+'_chd_2409.pth'
...
save_path = './model/'+label+'/'+"resnet18"+'_chd_2409.pth'
...
plt.savefig('./pic/'+label+'/AUC_{}_{}.pdf'.format(label,args.cohort), bbox_inches = 'tight') # , bbox_inches='tight'
